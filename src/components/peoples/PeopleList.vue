  ...
  <div class="relative px-4 py-10">
    ...
    <div class="relative mx-auto max-w-6xl px-4 pb-12">
      ...
      <div v-else class="flex flex-wrap justify-center gap-6">
        <div
          v-for="persone in items"
          :key="persone.uid"
          class="w-full sm:w-[320px]"
        >
          <div
            class="relative rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl"
          >
            ...
            <p
              v-if="persone.name"
              class="mt-4 text-base font-semibold text-white/90 text-center"
            >
              {{ persone.name }}
            </p>

            <p
              class="mt-1 text-xs uppercase tracking-wider text-white/45 text-center"
            >
              ID: {{ persone.uid }}
            </p>
              ...
              >
                <span
                  class="absolute inset-0 bg-linear-to-r
                         from-cyan-400/20 via-sky-400/10 to-rose-400/20 blur-xl"
                ></span>
              </span>
